...
// OPRAVA ZDE: Přidán typ pro stav formuláře InquirySheet
...
export async function submitInquiry(
  ...
  if (!process.env.RESEND_API_KEY) {
    ...
    return { success: false, message: "Chyba konfigurace serveru." };
  }
  ...
  try {
    ...
    return {
      success: true,
      message: "Děkujeme! Vaše zpráva byla odeslána. Ozvu se Vám co nejdříve.",
    };
  } catch (e) {
