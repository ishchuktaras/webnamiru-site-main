...
import { BarChart3, TrendingUp, Eye, MessageSquare, Heart, Users, Calendar, Download, RefreshCw } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Přehled výkonu</h2>
          <p className="text-slate-600">Sledujte klíčové metriky vašeho webu</p>
        </div>
