...
import { FileText, Search, Plus, Edit, Eye, Calendar, Tag, TrendingUp, ArrowLeft, Filter } from "lucide-react"
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-2 text-lg">Vytvářejte a spravujte blogový obsah</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
