...
export const metadata: Metadata = {
  ...
  generator: "v0.dev",
  keywords:
    "tvorba webů, webové stránky, Vysočina, web na míru, ekonom, strategické weby",
  authors: [{ name: "Web na míru" }],
  openGraph: {
    title: "webnamiru.site - Strategické weby, které vydělávají",
    description:
      "Tvořím weby, které nejsou jen vizitkou, ale funkčním obchodním nástrojem. Váš web od ekonoma.",
    type: "website",
    locale: "cs_CZ",
  },
};
