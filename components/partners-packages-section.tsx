...
export default function PartnersPackagesSection() {
  ...
  const partnerPackages = [
    // ... data balíčků zůstávají stejná ...
    {
      ...
      idealFor:
        "Svatební fotografové, produktoví fotografové, grafici, designéři loga a identity.",
      icon: Camera,
      popular: true,
    ...
    },
    {
      ...
      idealFor:
        "Digitální marketéři, SEO specialisté, business konzultanti, social media manageři.",
      icon: TrendingUp,
      popular: false,
    ...
    },
    {
      ...
      idealFor:
        "Freelance PM, malé digitální agentury, konzultační firmy, business developeři.",
      icon: Users,
      popular: false,
  ...
  return (
    ...
    >
      <div className="container px-4 md:px-6">
          ...
          {/* ... Úvodní nadpisy ... */}
           <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Hledám kreativní profesionály, kteří chtějí rozšířit své služby o
              webová řešení. Nabízím výhodné podmínky spolupráce a dlouhodobé
              partnerství.
            </p>
          </div>
        </div>
                ...
                >
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <CardTitle className="text-xl font-bold text-black dark:text-gray-50">
                          {pkg.name}
                        </CardTitle>
                  ...
                  <div className="mt-auto pt-6">
                    {/* === ZMĚNA ZDE: Sjednocení stylu tlačítek === */}
                    <Button
                    ...
                    >
                      <Link
                        href={`/kontakt?type=partnership&package=${pkg.name}`}
                      >
                        {pkg.commission === "Individuální"
                          ? "Domluvit spolupráci"
                          : "Začít spolupráci"}
                      </Link>
                    </Button>
        ...
        {/* ... Sekce s podmínkami spolupráce zůstává stejná ... */}
        <div className="mt-24 max-w-4xl mx-auto bg-white dark:bg-gray-900 p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold tracking-tighter">
              Zásady a podmínky férové spolupráce
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mt-2 max-w-2xl mx-auto">
              Kladu důraz na transparentnost, důvěru a oboustranně výhodné
              vztahy. Zde jsou klíčové principy našeho partnerství.
            </p>
          </div>
          <Accordion
            type="single"
             ...
             <AccordionItem value="item-1">
              <AccordionTrigger className="text-lg text-left hover:no-underline">
                <div className="flex items-center gap-3">
                  ...
                  <span>Jak to celé funguje? (Proces spolupráce)</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base text-gray-700 dark:text-gray-300 pt-2">
                <ol className="list-decimal list-inside space-y-2">
                  <li>
                    **Spojení:** Kontaktujete mě s vaší představou o
                    partnerství.
                  </li>
                  <li>
                    **Dohoda:** Společně probereme detaily, odsouhlasíme si výši
                    provize a podmínky.
                  </li>
                  <li>
                    **Doporučení:** Předáte mi kontakt na klienta, který má
                    zájem o webové služby.
                  </li>
                  <li>
                    **Komunikace:** Převezmu veškerou komunikaci s klientem
                    ohledně technických detailů a realizace projektu. Vás budu
                    průběžně informovat o stavu.
                  </li>
                  <li>
                    **Realizace:** Postarám se o kompletní vývoj webu od A do Z
                    v té nejvyšší kvalitě.
                  </li>
                  <li>
                    **Fakturace a provize:** Po dokončení projektu a úhradě od
                    klienta vám vyplatím sjednanou provizi.
                  </li>
                </ol>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-lg text-left hover:no-underline">
                <div className="flex items-center gap-3">
                  ...
                  <span>Výplata provizí</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base text-gray-700 dark:text-gray-300 pt-2">
                Provize je splatná po **plném uhrazení finální faktury**
                doporučeným klientem. Následně vás vyzvu k vystavení faktury na
                dohodnutou částku s obvyklou splatností 14 dní. Vše probíhá plně
                transparentně.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-lg text-left hover:no-underline">
                <div className="flex items-center gap-3">
                  ...
                  <span>Role a zodpovědnosti</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base text-gray-700 dark:text-gray-300 pt-2">
                <p className="mb-2">
                  <strong>Vaše role (partnera):</strong> Zajištění prvotního
                  kontaktu s klientem, představení mých služeb a předání
                  kontaktu. Očekává se, že klient je srozuměn s tím, že web bude
                  realizován mnou.
                </p>
                <p>
                  <strong>Moje role (webnamíru.site):</strong> Kompletní
                  převzetí zodpovědnosti za projekt – od komunikace s klientem,
                  přes návrh, vývoj, testování až po finální spuštění a
                  následnou podporu.
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger className="text-lg text-left hover:no-underline">
                <div className="flex items-center gap-3">
                  ...
                  <span>Záruky a kvalita</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base text-gray-700 dark:text-gray-300 pt-2">
                Zavazuji se, že každý vámi doporučený klient obdrží stejnou,
                ne-li vyšší, úroveň péče, kvality a profesionality jako moji
                přímí klienti. Vaše dobré jméno je pro mě stejně důležité jako
                to mé. Všichni klienti mají nárok na standardní 30denní záruku
                na technickou funkčnost webu.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-5">
              <AccordionTrigger className="text-lg text-left hover:no-underline">
                <div className="flex items-center gap-3">
                  ...
                  <span>Společný marketing a reference</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base text-gray-700 dark:text-gray-300 pt-2">
                U úspěšných projektů se rád dohodnu na společné případové
                studii. Po dohodě vás mohu uvést jako partnera na svém webu v
                sekci referencí, což může přinést další obchodní příležitosti i
                vám.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-6">
              <AccordionTrigger className="text-lg text-left hover:no-underline">
                <div className="flex items-center gap-3">
                  ...
                  <span>Exkluzivita a etika</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base text-gray-700 dark:text-gray-300 pt-2">
                Partnerství je **zcela neexkluzivní**. Můžete spolupracovat s
                kýmkoliv dalším. Klíčová je pro mě etika a jednání v nejlepším
                zájmu klienta. Nikdy nebudu tlačit na prodej služeb, které
                klient nepotřebuje.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
