...
import {
  ...
  FormLabel,
  FormMessage,
  FormDescription, // Přidán chybějící import FormDescription
...
const contactFormSchema = z.object({
  ...
  consent: z.boolean().refine((val) => val === true, {
    // Zde stále boolean pro React Hook Form
...
export default function ContactForm({ onClose, defaultService = "Nezávazná poptávka" }: ContactFormProps) {
  ...
  return (
    <div className="relative p-6 md:p-8 bg-background rounded-lg shadow-xl dark:bg-gray-900">
      ...
      <p className="text-gray-400 mb-8">Zanechte nám zprávu a brzy se vám ozvu.</p>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="hidden">
                {" "}
                {/* Skryjeme ho, protože už máme nadpis a defaultService */}
              ...
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 bg-gray-800 border-gray-700">
                ...
                <div className="space-y-1 leading-none">
                  <FormLabel className="text-gray-300">
                    ...
                    <Link href="/podminky" className="text-primary hover:underline">
