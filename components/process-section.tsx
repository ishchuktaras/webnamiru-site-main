...
export default function ProcessSection() {
  const processSteps = [
    {
      icon: <Search className="h-12 w-12 text-black dark:text-gray-50" />,
    ...
    {
      icon: <Code className="h-12 w-12 text-black dark:text-gray-50" />,
    ...
    {
      icon: <TrendingUp className="h-12 w-12 text-black dark:text-gray-50" />,
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-gray-900" data-section="process-section">
